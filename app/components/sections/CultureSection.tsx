...
// ImageWithFallback 대신 표준 img 태그 사용 (호환성 확보)
...
        <img
          src="https://placehold.co/1920x1080/ffffff/333?text=Korean+Traditional+Painting+Placeholder"
          alt="전통 회화"
...
        onError={(e) => (e.currentTarget.src = 'https://placehold.co/320x320/000000/fff?text=Shaman+Placeholder')}
    />
      </motion.div>
      
      {/* 장식 */}
...
              <p className="text-xl text-black/90 mt-2">예술과 문화의 뿌리</p> {/* 🛑 text-black/60 -> text-black/90 */}
            </div>
          </div>
        </motion.div>
...
                <p className="text-black/90 leading-relaxed mb-4"> {/* 🛑 text-black/70 -> text-black/90 */}
                  억울하게 죽은 영혼의 원한을 풀어주는 의례. 단순한 위로를 넘어 
                  집단적 치유와 사회적 정의 회복을 추구합니다.
                </p>
                <div className="pt-4 border-t border-black/10">
                  <span className="text-sm text-black/80">목적: 해원(解寃) · 치유 · 화해</span> {/* 🛑 text-black/50 -> text-black/80 */}
                </div>
              </div>
...
                </p>
                <div className="pt-4 border-t border-black/10">
                  <span className="text-sm text-black/80">작품: 더 글로리, 부활, 펜트하우스</span> {/* 🛑 text-black/50 -> text-black/80 */}
                </div>
              </div>
            </div>
          </div>
...
                  <h4 className="mb-3 text-black">{item.element}</h4>
                  <p className="text-sm text-black/90">{item.desc}</p> {/* 🛑 text-black/70 -> text-black/90 */}
                </div>
              ))}
            </div>
          </div>
...
              <ul className="space-y-4 text-black/90"> {/* 🛑 text-black/70 -> text-black/90 */}
...
              <p className="text-black/90 leading-relaxed mb-6"> {/* 🛑 text-black/80 -> text-black/90 */}
...
                <span className="text-sm text-[#2E5C8A]/90"> {/* 🛑 text-[#2E5C8A] -> text-[#2E5C8A]/90 */}
